...
for ssp in ['ssp585', 'rcp85']:
    ...
    for cart in listacarts:
        ...
        for filenam in file_list:
            ...
            command = 'cdo sellevel,40000,30000,25000,20000,15000 {} {}prov.nc'.format(file_in, cartut)
            os.system(command)
            command = 'cdo vertmean {}prov.nc {}'.format(cartut, file_out)
            os.system(command)
            ...
            command = 'cdo sellevel,100000,92500,85000,70000 {} {}prov.nc'.format(file_in, cartlt)
            os.system(command)
            command = 'cdo vertmean {}prov.nc {}'.format(cartlt, file_out)
            os.system(command)
