...
pickle.dump([mean_field_all, lowfrvar, highfrvar, stat_eddy_all], open(cart_out + 'out_lowhighstat_var_ERA.p', 'wb'))
...
fig = ctl.plot_map_contour(mean_field, lat, lon, title = '', filename = filename, visualization = projcos, bounding_lat = 0, plot_anomalies = False, cbar_range = [5000.,5800.], draw_grid = True, cb_label = 'm', central_lat_lon = clatlo)
all_figs_mf.append(fig)

filename = cart_out + 'low_fr_var_era_zg500.pdf'
fig = ctl.plot_map_contour(lowfr_variab, lat, lon, title = '', filename = filename, visualization = projcos, bounding_lat = 0, plot_anomalies = False, cbar_range = [10.,170.], draw_grid = True, cb_label = 'm', central_lat_lon = clatlo)
all_figs_lo.append(fig)

filename = cart_out + 'high_fr_var_era_zg500.pdf'
fig = ctl.plot_map_contour(highfr_variab, lat, lon, title = '', filename = filename, visualization = projcos, bounding_lat = 0, plot_anomalies = False, cbar_range = [5., 70.], draw_grid = True, cb_label = 'm', central_lat_lon = clatlo)
all_figs_hi.append(fig)

filename = cart_out + 'stat_eddy_era_zg500.pdf'
fig = ctl.plot_map_contour(stat_eddy, lat, lon, title = '', filename = filename, visualization = projcos, bounding_lat = 0, plot_anomalies = True, cbar_range = None, draw_grid = True, cb_label = 'm', central_lat_lon = clatlo)
