    ...
    for i, area in enumerate(['EAT', 'PNA']):
        ...
        for num, patt in enumerate(patnames):
            ...
            for cos in ['cmip5', 'cmip6']:
                ...
                ctl.Taylor_plot(modpats, obs, ax = ax, title = patt, colors = colors, only_first_quarter = True, plot_ellipse = False, ellipse_color = colors[0], max_val_sd = 1.6, markers = marknum, mod_points_size = 70, alpha_markers = 0.6)
