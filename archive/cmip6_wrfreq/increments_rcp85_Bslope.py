...
VARt='ta'
VARu='ua'
tmpDIR='/data-hobbes/fabiano/cmip5_UTW/'
...
MODELS=['ACCESS1-0', 'ACCESS1-3', 'BNU-ESM', 'CMCC-CESM', 'CMCC-CM', 'CMCC-CMS', 'CNRM-CM5', 'CanESM2', 'FGOALS-g2', 'GFDL-CM3', 'GFDL-ESM2G', 'HadGEM2-CC', 'HadGEM2-ES', 'IPSL-CM5A-MR', 'IPSL-CM5B-LR', 'MIROC-ESM-CHEM', 'MIROC-ESM', 'MIROC5', 'MPI-ESM-LR', 'MPI-ESM-MR', 'MRI-CGCM3', 'MRI-ESM1', 'NorESM1-M']

ENSEMBLES=['r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1', 'r1i1p1']

for mod, ens in zip(MODELS, ENSEMBLES):
    print(mod, ens)
    os.system('cdo -s -selyear,2015/2100 -fldmean -sellonlatbox,-180,180,60,90 -yearmean -selmonth,11,12,1,2,3 {}/ta_{}_{}_rcp85_2015-2100_LTmean_r1.nc {}AA_{}.nc'.format(INDIR_AA, mod, ens, tmpDIR, mod))
    os.system('cdo -s -selyear,2015/2100 -fldmean -sellonlatbox,-180,180,-30,30 -yearmean -selmonth,11,12,1,2,3 {}/ta_{}_{}_rcp85_2015-2100_UTmean_r1.nc {}TA_{}.nc'.format(INDIR_TA, mod, ens, tmpDIR, mod))
    os.system('cdo -s -selyear,2015/2100 -fldmean -sellonlatbox,-180,180,70,90 -yearmean -selmonth,11,12,1,2,3 {}/ta_{}_{}_rcp85_2015-2100_Smean_r1.nc {}PVt_{}.nc'.format(INDIR_PVt, mod, ens, tmpDIR, mod))
    os.system('cdo -s -selyear,2015/2100 -fldmean -sellonlatbox,-180,180,70,90  -yearmean -selmonth,11,12,1,2,3 {}/ua_{}_{}_rcp85_2015-2100_Smean_r1.nc {}PVu_{}.nc'.format(INDIR_PVu, mod, ens, tmpDIR, mod))
