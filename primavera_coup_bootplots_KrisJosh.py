...
#######################################
cart_in = '/home/fabiano/Research/lavori/prima_regimes_KS/'
...
for numclus in [3,4,5]:
    ...
    model_names = ['CMCC-CM2-HR4', 'CMCC-CM2-VHR4', 'CNRM-CM6-1', 'CNRM-CM6-1-HR', 'EC-Earth3P', 'EC-Earth3P-HR', 'ECMWF-IFS-LR', 'ECMWF-IFS-MR', 'ECMWF-IFS-HR', 'MPI-ESM1-2-HR', 'MPI-ESM1-2-XR', 'HadGEM3-GC31-LL', 'HadGEM3-GC31-MM', 'HadGEM3-GC31-HM', 'HadGEM3-GC31-HH']

    # vers = ['LR', 'HR', 'LR', 'HR', 'LR', 'HR', 'LR', 'HR', 'LR', 'MR', 'HR', 'LR', 'HR', 'LR', 'MR', 'MR', 'HR'] + ['OBS']
    vers = ['LR', 'HR', 'LR', 'HR', 'LR', 'HR', 'LR', 'MR', 'HR', 'LR', 'HR', 'LR', 'MR', 'MR', 'HR'] + ['OBS']
    ...
    fig_pers.savefig(cart_out + 'Persistence_bootstraps_v7_k{}.pdf'.format(numclus))
    ...
    ctl.plot_pdfpages(cart_out + 'all_bootplots_k{}.pdf'.format(numclus), allfigs, save_single_figs = False)
