...
dsst_all = pickle.load(open(cart_out + 'dsst_all.p', 'rb'))
...
ax.set_xlabel('Tropical Pacific W-E difference (K)')

cb = plt.colorbar(sc)
cb.set_label('Global tas (K)')

fig.savefig(cart_out + 'ensostd_vs_dsst_50.pdf')
