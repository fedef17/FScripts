...
for var in allvars:
    ...
    guplo3 = flux_lr[var].sel(time = slice('1999-01-01', '1999-01-30'), lat = slice(-20., 20.)).mean(['lon', 'lat']).plot(ylim = (1.e5, 1.e3), yscale = 'log', color = 'forestgreen')
    guplo2 = flux_hr[var].sel(time = slice('1999-01-01', '1999-01-30'), lat = slice(-20., 20.)).mean(['lon', 'lat']).plot(ylim = (1.e5, 1.e3), yscale = 'log', color = 'indianred')
    plt.title(var)
